...
def identity_facts_from_diligence(
    ...
    *,
    ...
    put("nox_median_views", summary.get("median_views"))
    put("nox_wave", summary.get("wave"))
    put("nox_avg_active_days", summary.get("avg_active_days"))
    put("nox_view_per_followers", summary.get("view_per_followers"))
    put("nox_performance_levels", summary.get("performance_levels"))
    put("nox_benchmark_ranks", summary.get("benchmark_ranks"))
    ...
    put("nox_channel_handle", summary.get("channel_handle"))
    put("nox_top_region", summary.get("audience_top_regions"))
    put("nox_audience_authenticity", summary.get("audience_authenticity"))
    put("nox_audience_authenticity_range", summary.get("audience_authenticity_range"))
    put("nox_audience_quality_score", summary.get("audience_quality_score"))
    put("nox_gender_skew", summary.get("gender_skew"))
    put("nox_audience_age_distribution", summary.get("audience_age_distribution"))
    put("nox_audience_languages_top", summary.get("audience_languages_top"))
    put("nox_audience_types_top", summary.get("audience_types_top"))
    put("nox_audience_adults_split", summary.get("audience_adults_split"))
    put("nox_audience_positive_pct", summary.get("audience_positive_pct"))
    put("nox_audience_promo_attractiveness", summary.get("audience_promo_attractiveness"))
    put("nox_audience_promo_interested_pct", summary.get("audience_promo_interested_pct"))
    put("nox_audience_promo_professionalism", summary.get("audience_promo_professionalism"))
    put("nox_audience_interests_top", summary.get("audience_interests_top"))
    put("nox_content_tags_top", summary.get("content_tags_top"))
    put("nox_content_tags_all", summary.get("content_tags_all"))
    put("nox_content_format_counts", summary.get("content_format_counts"))
    put("nox_content_engagement_split", summary.get("content_engagement_split"))
    put("nox_benchmark_rank", summary.get("benchmark_rank"))
    put("nox_channel_url", summary.get("channel_url"))
    put("nox_cooperation_score", summary.get("cooperation_score"))
    put("nox_cooperation_pros", summary.get("cooperation_pros"))
    put("nox_cooperation_cons", summary.get("cooperation_cons"))
    put("nox_cooperation_price_estimate", summary.get("cooperation_price_estimate"))
    put("nox_cooperation_first_price_range", summary.get("cooperation_first_price_range"))
    put("nox_cooperation_final_price_range", summary.get("cooperation_final_price_range"))
    put("nox_cooperation_avg_response_hours", summary.get("cooperation_avg_response_hours"))
    put("nox_cooperation_contact_efficiency", summary.get("cooperation_contact_efficiency"))
    put("nox_cooperation_ad_video_stats", summary.get("cooperation_ad_video_stats"))
    put("nox_cooperation_brands_top", summary.get("cooperation_brands_top"))
    put("nox_cooperation_confirmation_pct", summary.get("cooperation_confirmation_pct"))
    put("nox_cooperation_start_contact_pct", summary.get("cooperation_start_contact_pct"))
    put("nox_cooperation_promotion_online_pct", summary.get("cooperation_promotion_online_pct"))
    put("nox_cooperation_active_period", summary.get("cooperation_active_period"))
    put(
        "nox_cooperation_brand_video_engagement_rate",
        summary.get("cooperation_brand_video_engagement_rate"),
    )
    put("nox_dispute_types", summary.get("dispute_types"))
