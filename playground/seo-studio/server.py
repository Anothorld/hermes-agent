...
async def task_agent_run(task_id: str, step_num: int, body: dict | None = None) -> dict:
    ...
    step_guidance = {
        ...
        2: (
            ...
            "Use serp_fetch_google (SERP API) for SERP queries — do NOT use rpa_fetch_google_serp "
            "or browser_navigate for SERP (server IP is a datacenter IP, gets CAPTCHA'd). "
...
async def agent_run(rid: str, body: dict | None = None) -> dict:
    ...
    step_guidance_map = {
        "brainstorm": (
            ...
            "Use serp_fetch_google (SERP API) on keyword combinations — do NOT use "
            "rpa_fetch_google_serp or browser_navigate for SERP (the server IP is a "
            "datacenter IP and gets CAPTCHA'd by direct Google scraping). "
